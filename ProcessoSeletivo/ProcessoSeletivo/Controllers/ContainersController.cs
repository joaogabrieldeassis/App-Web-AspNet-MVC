...
namespace ProcessoSeletivo.Controllers
{
    ...
    {
        private readonly TesteDbContent _context;

        public ContainersController(TesteDbContent context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, Container container)
        {
            if (id != container.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(Guid id)
        {
            ...
            {
                return Problem("Entity set 'TesteDbContent.Containers'  is null.");
            }
            var container = await _context.Containers.FindAsync(id);
            if (container != null)
            {
